<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('home') }}"
            target="_blank">
                <img src=" {{asset('./img/task_logo.png')}}" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-1 font-weight-bold">Task Application</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'tasks') == true ? 'active' : '' }}" href="{{ route('tasks.index') }}">
                    ...
                    <span class="nav-link-text ms-1">List of Tasks</span>
                </a>
            </li>
            <li class="nav-item">
